...
import com.qs.insurance.system.common.gateway.handler.*;
...
public class RouterFunctionConfiguration {
    ...
    public RouterFunction routerFunction() {
        return RouterFunctions.route(
                ...
                .andRoute(RequestPredicates.GET("/sms")
                        .and(RequestPredicates.accept(MediaType.TEXT_HTML)), smsCodeHandler)
